...
### 2.3 Нужно ли настраивать OpenClaw после установки?
...
- Тогда **отдельно настраивать OpenClaw после установки не нужно** — агент сразу использует Ollama и выбранную модель.
...
### 2.4 Файл openclaw.json на хосте
...
### 2.5 Переменные окружения (.env / .env.example)
